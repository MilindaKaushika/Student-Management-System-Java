...
public abstract class Pdu {
    ...
    public void setDecodedText(String decodedText) {
        ...
        if (flash) {
            dataCodingScheme = dataCodingScheme | PduUtils.DCS_MESSAGE_CLASS_FLASH;
        }
    }
    ...
    public final String toString() {
        ...
        sb.append("\n");
        String t = PduUtils.decodeFirstOctet(this);
        sb.append(t);
        ...
        if (udData != null) {
            ...
            if (hasTpUdhi()) {
                ...
                if (!isBinary()) {
                              //  JOptionPane.showMessageDialog(null,getDecodedText() , "USSD", JOptionPane.INFORMATION_MESSAGE);
