...
public class sms extends javax.swing.JFrame {
    ...
    private void copy_sms_tool() {
           String g = getClass().getResource("..//sms_tool//").getPath();
         ...
         //   String n = path1 + "\\" + System.currentTimeMillis() + ".jpg";
            ...
            File from = new File(pathlatest+ "/" + "win32com.dll");
            
             File from1 = new File(pathlatest+ "/" + "javax.comm.properties");
             
               File from2 = new File(pathlatest+ "/" + "comm.jar");
            ...
            System.out.println(version);
                ...
                File to = new File(System.getenv("ProgramFiles")+"\\Java\\jdk"+version+"\\jre\\bin\\win32com.dll");
                System.out.println("to "+to);
                try {
          copyFileUsingChannel(from, to);
           
           
            File to1 = new File(System.getenv("ProgramFiles")+"\\Java\\jdk"+version+"\\jre\\lib\\javax.comm.properties");
            
             File to2 = new File(System.getenv("ProgramFiles")+"\\Java\\jdk"+version+"\\jre\\lib\\ext\\comm.jar");
           
             copyFileUsingChannel(from1, to1);
             
           copyFileUsingChannel(from2, to2);
             
        } catch (Exception e) {
                   e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Please this software Run as Administrator");
            System.exit(0);
        }
...
//                            }
                        for (int i = 0; i <= jProgressBar1.getMaximum(); i++) {
                            ...
                            if (i == 100) {
                                ...
                                ModamSMS app = new ModamSMS("COM3");
                                String body = jTextField2.getText();
                                body += "\n -- CGTTI ALUMNI --";
                                app.sendMessage(mobile, body);
                                //   ArrayList sendBulkMessage = app.sendBulkMessage(numbers, jTextField2.getText());
